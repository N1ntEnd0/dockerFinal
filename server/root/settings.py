...
DEFAULT_SHARED_USER = env('DEFAULT_SHARED_USER')
DEFAULT_SHARED_FOLDER = env('DEFAULT_SHARED_FOLDER')

AUTH_USER_MODEL = 'users.User'
# SOCIAL_AUTH_USER_MODEL = 'users.UserSocialModel'
ALLOWED_HOSTS = ['*']
...
DRIVE_URL_PATTERN = 'https://docs.google.com/{}/d/{}/edit'
SOCIAL_AUTH_JSONFIELD_ENABLED = True
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = env('SOCIAL_AUTH_GOOGLE_OAUTH2_KEY')
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = env('SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET')
SOCIAL_AUTH_RAISE_EXCEPTIONS = False
SOCIAL_AUTH_DEFAULT_PROVIDER = 'google-oauth2'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    # 'users.pipeline.check_token',
    'social_core.pipeline.user.get_username',
    'social_core.pipeline.user.create_user',  # <--- set the path to the function
...
MIDDLEWARE = [
    ...
    'users.middleware.CheckSocialAuthToken'
]
...
# DJOSER SETTINGS
# white_list = ['', ' ', 'http://localhost:80/', 'http://localhost:80', 'http://localhost:3050', 'http://localhost:3050/', 'http://localhost:8000/accounts/profile/', 'http://localhost:3000/', 'https://share-my-gdrive.herokuapp.com/accounts/profile/', 'https://infinity-gdrive.space', 'https://infinity-gdrive.space/']
